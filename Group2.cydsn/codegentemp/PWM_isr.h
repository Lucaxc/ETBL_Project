...
**************************************/
#define PWM_isr_INIT_PERIOD_VALUE          (2399u)
#define PWM_isr_INIT_COMPARE_VALUE1        (1200u)
#define PWM_isr_INIT_COMPARE_VALUE2        (10000u)
...
#define PWM_isr_DEFAULT_COMPARE2_MODE      (uint8)((uint8)4u <<  PWM_isr_CTRL_CMPMODE2_SHIFT)
