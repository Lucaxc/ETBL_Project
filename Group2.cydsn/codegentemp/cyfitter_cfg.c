...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000550u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000574u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800057Cu)
...
uint8 CYXDATA * const CYCODE AMux_TIA_input__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_DAC0_SW4, (uint8 CYXDATA *)CYREG_SC2_SW0, 
	(uint8 CYXDATA *)CY_AMUX_UNUSED, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_TIA_input__maskTable[4] = {
	0x02u, 0x02u, 
	0x00u, 0x00u, 
};
...
void AMux_TIA_input_Set(uint8 channel)
{
	...
	{
		channel += channel;
		*AMux_TIA_input__addrTable[channel] |= AMux_TIA_input__maskTable[channel];
		channel++;
		*AMux_TIA_input__addrTable[channel] |= AMux_TIA_input__maskTable[channel];
	}
}
...
void AMux_TIA_input_Unset(uint8 channel)
{
	...
	{
		channel += channel;
		*AMux_TIA_input__addrTable[channel] &= (uint8)~AMux_TIA_input__maskTable[channel];
		channel++;
		*AMux_TIA_input__addrTable[channel] &= (uint8)~AMux_TIA_input__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_TIA_resistor_bypass__addrTable[1] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_TIA_resistor_bypass__maskTable[1] = {
	0x04u, 
};

/*******************************************************************************
* Function Name: AMux_TIA_resistor_bypass_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void AMux_TIA_resistor_bypass_Set(uint8 channel)
{
	if (channel < 1)
	{
		*AMux_TIA_resistor_bypass__addrTable[channel] |= AMux_TIA_resistor_bypass__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: AMux_TIA_resistor_bypass_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void AMux_TIA_resistor_bypass_Unset(uint8 channel)
{
	if (channel < 1)
	{
		*AMux_TIA_resistor_bypass__addrTable[channel] &= (uint8)~AMux_TIA_resistor_bypass__maskTable[channel];
	}
}
