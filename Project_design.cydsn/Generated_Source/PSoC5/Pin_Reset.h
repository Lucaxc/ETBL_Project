...
void    Pin_Reset_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_Reset_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_Reset__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_Reset_SetInterruptMode() function.
     *  @{
     */
        #define Pin_Reset_INTR_NONE      (uint16)(0x0000u)
        #define Pin_Reset_INTR_RISING    (uint16)(0x0001u)
        #define Pin_Reset_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_Reset_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_Reset_INTR_MASK      (0x01u) 
#endif /* (Pin_Reset__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_Reset__SIO_CFG)
    #define Pin_Reset_SIO_HYST_EN        (* (reg8 *) Pin_Reset__SIO_HYST_EN)
    #define Pin_Reset_SIO_REG_HIFREQ     (* (reg8 *) Pin_Reset__SIO_REG_HIFREQ)
    #define Pin_Reset_SIO_CFG            (* (reg8 *) Pin_Reset__SIO_CFG)
    #define Pin_Reset_SIO_DIFF           (* (reg8 *) Pin_Reset__SIO_DIFF)
#endif /* (Pin_Reset__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_Reset_0_INTTYPE_REG 		(* (reg8 *) Pin_Reset__0__INTTYPE)
#endif /* (Pin_Reset__INTSTAT) */
